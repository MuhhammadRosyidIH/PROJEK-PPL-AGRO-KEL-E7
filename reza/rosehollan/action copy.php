				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						'<div class="row">
								...
								<div class="col-md-2"><input type="text" class="form-control price total" value="'.$product_price.'" readonly="readonly"></div>
							</div>';
				}
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/rosehollan/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/rosehollan/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/rosehollan/cancel.php"/>
