    ...
    <div class="left fixed-top" align="center" style="background-color: crimson; width: 22.5%; height: 100vh; ">
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="row" align="left" style="padding-left: 70px;">
                ...
                <a href="pencatatan.php" class="navbar-brand nav-now" style="margin-top: 20px; cursor: pointer; font-size: 20px; font-weight: 600;"><i class="bi bi-journal-medical me-2"></i> Pencatatan</a>
        ...
        <div class="card" align="center" style="width: 95%; margin-left: 2.5%;">
            <div class="card-body">
                <div class="d-flex justify-content-between">
                    <div align="left" style="margin-top: 10px; margin-right: 45px; margin-bottom: 10px; color: black;">
                        <h6>Total Pendapatan <span style="margin-left: 30px;">: Rp. </span></h6>
                        <h6>Total Pengeluaran <span style="margin-left: 26.5px;">: Rp. </span></h6>
                        <h6>Laba Bersih <span style="margin-left: 73.5px;">: Rp. </span></h6>
                    </div>
                    <div style="margin-top: 10px; margin-right: 45px; margin-bottom: 10px;">
