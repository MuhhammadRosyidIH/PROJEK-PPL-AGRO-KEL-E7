    ...
    <div class="left fixed-top" align="center" style="background-color: crimson; width: 22.5%; height: 100vh; ">
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="row" align="left" style="padding-left: 70px;">
                ...
                <a href="produksi.php" class="navbar-brand nav-now" style="margin-top: 20px; cursor: pointer; font-size: 20px; font-weight: 600;"><i class="bi bi-journal-album me-2"></i> Produksi</a>
            </div>
        </div> 
    </div>
