    ...
    <div class="left fixed-top" align="center" style="background-color: crimson; width: 22.5%; height: 100vh; ">
        <div class="row" style="margin-top: 20px;">
            ...
            <div class="row" align="left" style="padding-left: 70px;">
                ...
                <a href="pesanan.php" class="navbar-brand nav-now" style="margin-top: 20px; cursor: pointer; font-size: 20px; font-weight: 600;"><i class="bi bi-bag me-2"></i> Pesanan</a>
            ...
            <div class="modal-body">
                <form action="" method="POST" class="form-user">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nama_customer" class="form-control" id="nama_customer" title="Nama Customer" required>
                    </div>
                    <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat *</label>
                        <input type="text" name="alamat" class="form-control" id="alamat" title="Alamat" required>
                    </div>
                    <div class="mb-3">
                        <label for="no_telp" class="form-label">No. Handphone *</label>
                        <textarea name="no_telp" class="form-control" id="no_telp" title="Nomor Handphone" rows="3" required></textarea>
                    </div>
